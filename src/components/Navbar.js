...
function Navbar({allowSound,setAllowSound,darkMode,setDarkMode}) {
  ...
  return (
    <div className='h-[80px] w-full'>
        ...
        <div className={hideSidebar?`fixed h-screen right-0 w-[350px]  flex-col gap-10 max-w-screen  bg-[#70D857] z-90 hidden`:`fixed h-screen bg-[#70D857] right-0 w-[350px] flex flex-col gap-10 max-w-screen z-90`}>
