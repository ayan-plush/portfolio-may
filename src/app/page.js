...
export default function Home() {
  ...
  return ( 
    <div ref={containerRef} className={`overflow-y-hidden h-screen max-h-screen ${darkMode?'bg-[#000]':'bg-[#f9fcea]'} flex flex-col justify-between pt-[80px] items-center`}>
      ...
      <div style={{ backgroundImage: darkMode?`url(${imagesArray.darkPc})`:`url(${imagesArray.pc})` }} className= {`select-none relative max-md:mt-40 max-sm:w-[400px] max-sm:h-[400px] max-lg:w-[500px] max-lg:h-[500px] w-[650px] max-w-[100dvw] h-[650px]  bg-center bg-contain bg-no-repeat `} >
